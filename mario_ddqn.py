...
def create_video(imgs_dir, episode):
    ...
    out = cv2.VideoWriter('vis/ddqn/videos/ep_' + '{0:05d}'.format(episode) + '.mp4',cv2.VideoWriter_fourcc(*'mp4v'), 15, size)
...
def main():
    ...
    episodes = 40000
    os.makedirs('vis/ddqn/videos')
    for e in range(episodes):
        imgs_dir = "vis/ddqn/ep_" + '{0:05d}'.format(e)
